...
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME,PEOPLE,STATUS, MONEY, AMOUNT) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P003','R000001','R000002','R000003',to_date('2019-05-03 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2019-05-10 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,9,2, 599.4, 50);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME,PEOPLE,STATUS, MONEY, AMOUNT) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P004','R000001','R000002','R000003',to_date('2019-05-03 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2019-05-10 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,9,2, 599.4, 50);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME,PEOPLE,STATUS, MONEY, AMOUNT) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P005','R000001','R000002','R000003',to_date('2019-05-03 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2019-05-10 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,9,2, 599.4, 50);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME,PEOPLE,STATUS, MONEY, AMOUNT) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P006','R000003','R000006','R000009',SYSDATE-1, SYSDATE+7,7,2,0, 1811, 50);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME,PEOPLE,STATUS, MONEY, AMOUNT) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P007','R000001','R000002','R000003',SYSDATE,SYSDATE+7,7,3,0, 1811, 50);
