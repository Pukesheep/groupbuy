...
INSERT INTO GRO_ORDER(ORD_ID,MEM_ID,GRO_ID,ORDSTAT_ID,ORD_DATE, ORD_PRICE, RECEIVE_NAME, ADDRESS, PHONE) VALUES ('GO'||LPAD(GRO_ORDER_seq.NEXTVAL,6,'0'),'M000001','G000001','001',to_date('2020-04-17 01:03:20', 'yyyy-mm-dd hh24:mi:ss'), 500, '小春', '桃園市中壢區中和路139號', '0912345678');
...
INSERT INTO GRO_ORDER(ORD_ID,MEM_ID,GRO_ID,ORDSTAT_ID,ORD_DATE, ORD_PRICE, RECEIVE_NAME, ADDRESS, PHONE) VALUES ('GO'||LPAD(GRO_ORDER_seq.NEXTVAL,6,'0'),'M000003','G000003','003',to_date('2020-02-17 01:03:20', 'yyyy-mm-dd hh24:mi:ss'), 2000, '小秋', '桃園市平鎮區廣泰路77號', '0956781233');
INSERT INTO GRO_ORDER(ORD_ID,MEM_ID,GRO_ID,ORDSTAT_ID,ORD_DATE, ORD_PRICE, RECEIVE_NAME, ADDRESS, PHONE) VALUES ('GO'||LPAD(GRO_ORDER_seq.NEXTVAL,6,'0'),'M000004','G000004','004',to_date('2020-01-17 01:03:20', 'yyyy-mm-dd hh24:mi:ss'), 5000, '小冬', '桃園市平鎮區延平路二段56號', '0912358212');
