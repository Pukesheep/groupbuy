...
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME_DATE,PEOPLE,STATUS, MONEY) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P001','R000001','R000002','R000003',to_date('2019-05-03 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2019-05-10 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,9,0, 599.4);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME_DATE,PEOPLE,STATUS, MONEY) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P002','R000004','R000005','R000006',to_date('2019-06-03 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2019-06-07 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,6,0, 313);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME_DATE,PEOPLE,STATUS, MONEY) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P003','R000007','R000008','R000009',to_date('2019-09-11 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2019-09-18 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,20,1, 2528);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME_DATE,PEOPLE,STATUS, MONEY) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P004','R000001','R000003','R000005',to_date('2020-02-06 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2020-02-13 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,15,1, 3316);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME_DATE,PEOPLE,STATUS, MONEY) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P005','R000002','R000004','R000006',to_date('2020-03-28 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2020-04-04 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,3,2, 2729);
INSERT INTO GROUPBUY(GRO_ID,P_ID,REB1_NO,REB2_NO,REB3_NO,START_DATE,END_DATE,GROTIME_DATE,PEOPLE,STATUS, MONEY) VALUES ('G'||LPAD(GROUPBUY_seq.NEXTVAL,6,'0'),'P006','R000003','R000006','R000009',to_date('2020-04-17 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),to_date('2020-04-24 01:03:20', 'yyyy-mm-dd hh24:mi:ss'),7,2,2, 1811);

-----------------------------新增團購案-----------------------------

-----------------------------新增團購訂單-----------------------------

INSERT INTO GRO_ORDER(ORD_ID,MEM_ID,GRO_ID,ORDSTAT_ID,ADD_DATE) VALUES ('O'||LPAD(GRO_ORDER_seq.NEXTVAL,9,'0'),'M000001','G000001','001','2020-8-8-16:30');
INSERT INTO GRO_ORDER(ORD_ID,MEM_ID,GRO_ID,ORDSTAT_ID,ADD_DATE) VALUES ('O'||LPAD(GRO_ORDER_seq.NEXTVAL,9,'0'),'M000002','G000002','002','2020-11-18-13:20');
INSERT INTO GRO_ORDER(ORD_ID,MEM_ID,GRO_ID,ORDSTAT_ID,ADD_DATE) VALUES ('O'||LPAD(GRO_ORDER_seq.NEXTVAL,9,'0'),'M000003','G000003','003','2020-12-12-09:20');
INSERT INTO GRO_ORDER(ORD_ID,MEM_ID,GRO_ID,ORDSTAT_ID,ADD_DATE) VALUES ('O'||LPAD(GRO_ORDER_seq.NEXTVAL,9,'0'),'M000004','G000004','004','2020-12-20-18:26');
